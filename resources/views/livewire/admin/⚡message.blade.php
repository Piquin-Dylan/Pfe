...
<div>
    ...
    <section class="ml-6 mr-6  lg:items-center lg:flex-col ">
        ...
        @foreach($notifications as $notification)
            ...
            <div
                class="mx-6 mb-8 bg-gradient-to-br from-[#0f172a] to-[#020617] border border-white/10 rounded-2xl p-6 flex flex-col gap-5 text-white transition hover:translate-y-[-2px] hover:border-white/20 max-w-3xl w-full">
