@props([
    ...
    'action' => null,
    'redirection' => null,
    'containerClass' => 'lg:pt-28'
])

<div class="relative flex items-center justify-center min-h-screen px-4 py-4 {{ $containerClass }}">    <div class="w-full max-w-5xl  bg-white/5 border border-white/10 rounded-2xl shadow-2xl">
