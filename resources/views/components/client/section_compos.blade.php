        ...
        currentFormation: '4-3-3'
            ...
            <div class="rounded-3xl p-6">
                ...
                <div class="flex justify-center">
                    <label for="team" class="sr-only">
                        Formation
                    </label>

                    <select name="team" id="team" x-model="currentFormation" class="w-fit min-w-[220px] rounded-2xl bg-[#25284B]
                    ...
                    <template
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    class="  px-3 py-1 rounded-xl text-white text-sm font-semibold  min-w-[80px] text-center"
                                    x-text="assignedPlayers[player.poste] || player.poste"></div>
                            </div>
                        </div>
                    </template>
                </div>
            ...
            <span class="text-white text-2xl font-bold">
                Joueurs
                    ...
                    <p class="text-sm text-purple-400 mt-1" x-show="selectedPlayer"
                       x-text="'Poste sélectionné : ' + selectedPlayer"></p>
                </div>
                           ...
                           p-4 cursor-pointer transition hover:bg-[#2D315D]">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400 uppercase" x-text="player.position"></p>
